...
string jecfile = "jecfiles/2024ppRef_withPU_L2Relative_AK4PF.txt.txt";
string MCjecfile = "jecfiles/2024ppRef_withPU_L2Relative_AK4PF.txt.txt";
string l2file = "jecfiles/L2Residuals_2024ppRef.txt.txt";

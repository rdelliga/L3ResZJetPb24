// Print uncertainty component for uncertainties shifted up or down
...
void L2res_uncertainty(TString inFileName = "ptfits/testing_pt_dep.root", TString kfactFile = "L2fits_AK4CHSjetveto_all/correctionfile.root", TString outFileName = "uncertainty-param.txt", bool loglin = true) {

  // TODO: actual up and down variations
   TFile *inFile = new TFile(inFileName, "READ");
   TFile *inKfacts = new TFile(kfactFile, "READ");

   TFile *inFileUp = new TFile(inFileName, "READ");
   TFile *inKfactsUp = new TFile(kfactFile, "READ");

   TFile *inFileDown = new TFile(inFileName, "READ");
   TFile *inKfactsDown = new TFile(kfactFile, "READ");

   
   auto kfacts = (TH1D*)inKfacts->Get("ratio");
   auto kfactsUp = (TH1D*)inKfacts->Get("ratio");
   auto kfactsDown = (TH1D*)inKfacts->Get("ratio");

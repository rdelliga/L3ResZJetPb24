...
void plottriggereff() {
  ...
  string ZBfilename = "HIJEC_results/rerunall/zerobiasall_nojetid.root";   //TODO: merge - is this with calo?
  ...
  // TODO: use correct file
   ...
   c1->SetLogx();
  c1->Print(Form("triggerstudy/triggerturnon_leading_pf_nojetid.png"));

  c2->SetLogx();
  c2->Print(Form("triggerstudy/triggerturnon_ptavg_pf_nojetid.png"));
